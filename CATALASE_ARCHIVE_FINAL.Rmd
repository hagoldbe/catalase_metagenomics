...
arrange((Sal_co))
#
catmodels_notArctic_new_clean_SRF_extra_Sal_POC <- catmodels_notArctic_new_clean_SRF_extra_POC_Sal[-c(1),]
...
normKatG8_syn <-  mgcv::gam((log10normKatG) ~ s(Temp_co) + s(Sal_co) + s(PO4_co) + POC + synDarwin_umolC.kg, data=catmodels_notArctic_new_clean_SRF_extra_Sal_POC_log, method = "REML")
...
#prepare figure for just enviro FINAL 
...
panel.grid.major = element_blank(), 
        panel.grid.minor = element_blank(),
        panel.border = element_rect(colour = "black", fill=NA, linewidth=1)) + xlab("POC (µg/kg)") + ylab("log10 katG\ncopy number per genome")
...
panel.grid.major = element_blank(), 
        panel.grid.minor = element_blank(),
        panel.border = element_rect(colour = "black", fill=NA, linewidth=1)) + xlab("Iron concentration (µmol/kg) at 5 meters") + ylab("log10 katG\ncopy number per genome")
...
grid.arrange(katE_PO4, katE_Sal, ncol=2)

##showing other things

#biological predictors FINAL JAN 22 2025
...
panel.grid.major = element_blank(), 
        panel.grid.minor = element_blank(),
        panel.border = element_rect(colour = "black", fill=NA, linewidth=1)) + xlab("sar11 biomass (µmol C/kg)") + ylab("log10 katG\ncopy number per genome")

###also plot this for supplemental fig.
...
panel.grid.major = element_blank(), 
        panel.grid.minor = element_blank(),
        panel.border = element_rect(colour = "black", fill=NA, linewidth=1)) + xlab("sar11 biomass (µmol C/kg)") + ylab("katE\ncopy number per genome")

katE_sar11_temp <- plot(ggeffects::ggpredict(normKatE8_sar11, terms = "Temp_co"), show_data = TRUE, colors = "darkgrey", dot_size = 2, line_size = 1) + theme_bw() + ggtitle("") + theme(text=element_text(size=12), panel.background = element_blank(),
panel.grid.major = element_blank(), 
        panel.grid.minor = element_blank(),
        panel.border = element_rect(colour = "black", fill=NA, linewidth=1)) + xlab("Temperature (°C)") + ylab("katE\ncopy number per genome")

katE_sar11_Sal <- plot(ggeffects::ggpredict(normKatE8_sar11, terms = "Sal_co"), show_data = TRUE, colors = "darkgrey", dot_size = 2, line_size = 1) + theme_bw() + ggtitle("") + theme(text=element_text(size=12), panel.background = element_blank(),
panel.grid.major = element_blank(), 
        panel.grid.minor = element_blank(),
        panel.border = element_rect(colour = "black", fill=NA, linewidth=1)) + xlab("Salinity (PSU)") + ylab("katE\ncopy number per genome")

katE_sar11_fe <- plot(ggeffects::ggpredict(normKatE8_sar11, terms = "Iron_5m"), show_data = TRUE, colors = "darkgrey", dot_size = 2, line_size = 1) + theme_bw() + ggtitle("") + theme(text=element_text(size=12), panel.background = element_blank(),
panel.grid.major = element_blank(), 
        panel.grid.minor = element_blank(),
        panel.border = element_rect(colour = "black", fill=NA, linewidth=1)) + xlab("Iron concencentration (µmol/kg)") + ylab("katE\ncopy number per genome")

grid.arrange(katE_sar11, katE_sar11_temp, katE_sar11_Sal, katE_sar11_fe)
#####
...
panel.grid.major = element_blank(), 
        panel.grid.minor = element_blank(),
        panel.border = element_rect(colour = "black", fill=NA, linewidth=1)) + xlab("Synechococcus biomass (µg/kg)") + ylab("log10 katG\ncopy number per genome")


###repeat for all of the other predictors
katG_syn_temp <- plot(ggeffects::ggpredict(normKatG8_syn, terms = "Temp_co"), show_data = TRUE, colors = "darkgrey", dot_size = 2, line_size = 1) + theme_bw() + ggtitle("") + theme(text=element_text(size=12), panel.background = element_blank(),
panel.grid.major = element_blank(), 
        panel.grid.minor = element_blank(),
        panel.border = element_rect(colour = "black", fill=NA, linewidth=1)) + xlab("Temperature (°C)") + ylab("log10 katG\ncopy number per genome")

katG_syn_sal <- plot(ggeffects::ggpredict(normKatG8_syn, terms = "Sal_co"), show_data = TRUE, colors = "darkgrey", dot_size = 2, line_size = 1) + theme_bw() + ggtitle("") + theme(text=element_text(size=12), panel.background = element_blank(),
panel.grid.major = element_blank(), 
        panel.grid.minor = element_blank(),
        panel.border = element_rect(colour = "black", fill=NA, linewidth=1)) + xlab("Salinity (PSU)") + ylab("log10 katG\ncopy number per genome")

katG_syn_PO4 <- plot(ggeffects::ggpredict(normKatG8_syn, terms = "PO4_co"), show_data = TRUE, colors = "darkgrey", dot_size = 2, line_size = 1) + theme_bw() + ggtitle("") + theme(text=element_text(size=12), panel.background = element_blank(),
panel.grid.major = element_blank(), 
        panel.grid.minor = element_blank(),
        panel.border = element_rect(colour = "black", fill=NA, linewidth=1)) + xlab("PO4 concentration (µg/kg)") + ylab("log10 katG\ncopy number per genome")

katG_syn_POC <- plot(ggeffects::ggpredict(normKatG8_syn, terms = "POC"), show_data = TRUE, colors = "darkgrey", dot_size = 2, line_size = 1) + theme_bw() + ggtitle("") + theme(text=element_text(size=12), panel.background = element_blank(),
panel.grid.major = element_blank(), 
        panel.grid.minor = element_blank(),
        panel.border = element_rect(colour = "black", fill=NA, linewidth=1)) + xlab("POC (µg/kg)") + ylab("log10 katG\ncopy number per genome")
...
panel.grid.major = element_blank(), 
        panel.grid.minor = element_blank(),
        panel.border = element_rect(colour = "black", fill=NA, linewidth=1)) + xlab("Prochlorococcus biomass (µmol C/kg)") + ylab("log10 katG\ncopy number per genome")
...
panel.grid.major = element_blank(), 
        panel.grid.minor = element_blank(),
        panel.border = element_rect(colour = "black", fill=NA, linewidth=1)) + xlab("Prochlorococcus HLI (µg/kg)") + ylab("log10 katG\ncopy number per genome")

katG_HLI_temp <- plot(ggeffects::ggpredict(normKatG11_HL, terms = "Temp_co"), show_data = TRUE, colors = "darkgrey", dot_size = 2, line_size = 1) + theme_bw() + ggtitle("") + theme(text=element_text(size=12), panel.background = element_blank(),
panel.grid.major = element_blank(), 
        panel.grid.minor = element_blank(),
        panel.border = element_rect(colour = "black", fill=NA, linewidth=1)) + xlab("Temperature (°C)") + ylab("log10 katG\ncopy number per genome")

katG_HLI_sal <- plot(ggeffects::ggpredict(normKatG11_HL, terms = "Sal_co"), show_data = TRUE, colors = "darkgrey", dot_size = 2, line_size = 1) + theme_bw() + ggtitle("") + theme(text=element_text(size=12), panel.background = element_blank(),
panel.grid.major = element_blank(), 
        panel.grid.minor = element_blank(),
        panel.border = element_rect(colour = "black", fill=NA, linewidth=1)) + xlab("Salinity (PSU)") + ylab("log10 katG\ncopy number per genome")

katG_HLI_PO4 <- plot(ggeffects::ggpredict(normKatG11_HL, terms = "PO4_co"), show_data = TRUE, colors = "darkgrey", dot_size = 2, line_size = 1) + theme_bw() + ggtitle("") + theme(text=element_text(size=12), panel.background = element_blank(),
panel.grid.major = element_blank(), 
        panel.grid.minor = element_blank(),
        panel.border = element_rect(colour = "black", fill=NA, linewidth=1)) + xlab("Phosphate concentration (µg/kg)") + ylab("log10 katG\ncopy number per genome")

katG_HLI_POC <- plot(ggeffects::ggpredict(normKatG11_HL, terms = "POC"), show_data = TRUE, colors = "darkgrey", dot_size = 2, line_size = 1) + theme_bw() + ggtitle("") + theme(text=element_text(size=12), panel.background = element_blank(),
panel.grid.major = element_blank(), 
        panel.grid.minor = element_blank(),
        panel.border = element_rect(colour = "black", fill=NA, linewidth=1)) + xlab("POC (µg/kg)") + ylab("log10 katG\ncopy number per genome")

#repeating for the sar11 model
katG_sar11_sal <- plot(ggeffects::ggpredict(normKatG7_sar11, terms = "Sal_co"), show_data = TRUE, colors = "darkgrey", dot_size = 2, line_size = 1) + theme_bw() + ggtitle("") + theme(text=element_text(size=12), panel.background = element_blank(),
panel.grid.major = element_blank(), 
        panel.grid.minor = element_blank(),
        panel.border = element_rect(colour = "black", fill=NA, linewidth=1)) + xlab("Salinity (PSU)") + ylab("log10 katG\ncopy number per genome")

katG_sar11_fe <- plot(ggeffects::ggpredict(normKatG7_sar11, terms = "Iron_5m"), show_data = TRUE, colors = "darkgrey", dot_size = 2, line_size = 1) + theme_bw() + ggtitle("") + theme(text=element_text(size=12), panel.background = element_blank(),
panel.grid.major = element_blank(), 
        panel.grid.minor = element_blank(),
        panel.border = element_rect(colour = "black", fill=NA, linewidth=1)) + xlab("Iron concentration (µg/kg)") + ylab("log10 katG\ncopy number per genome")

katG_sar11_POC <- plot(ggeffects::ggpredict(normKatG7_sar11, terms = "POC"), show_data = TRUE, colors = "darkgrey", dot_size = 2, line_size = 1) + theme_bw() + ggtitle("") + theme(text=element_text(size=12), panel.background = element_blank(),
panel.grid.major = element_blank(), 
        panel.grid.minor = element_blank(),
        panel.border = element_rect(colour = "black", fill=NA, linewidth=1)) + xlab("POC (µg/kg)") + ylab("log10 katG\ncopy number per genome")
######I also need to include outputs from the syn models

###also need to include the sar11 katE models

##also need to include the katE enviro models


###grid arrange for all of the supplemental plots

grid.arrange(katG_Sal, katG_HLI_temp, katG_HLI_sal, katG_HLI_PO4, katG_HLI_POC, katG_HLI, katG_sar11_sal, katG_sar11_fe, katG_sar11_POC, katG_syn, katG_syn_temp,
             katG_syn_sal, katG_syn_PO4, katG_syn_POC, ncol = 2)


#let's separate each of these by model now
#model 1
katG_Sal

#now model 2
grid.arrange(katG_HLI_temp, katG_HLI_sal, katG_HLI_PO4, katG_HLI_POC, katG_HLI, ncol = 2)

#now model 3
grid.arrange(katG_sar11_sal, katG_sar11_fe, katG_sar11_POC, ncol = 2)

#now model 4
grid.arrange(katG_syn, katG_syn_temp,
             katG_syn_sal, katG_syn_PO4, katG_syn_POC, ncol = 2)
...
grid.arrange(katG_POC, katG_Iron, katG_sar11, katG_pro, ncol = 2)
...
#remove log transformation for graphing
normKatE_large_enviro_new9
normKatG6_large_enviro_filt
...
panel.grid.major = element_blank(), 
        panel.grid.minor = element_blank(),
        panel.border = element_rect(colour = "black", fill=NA, linewidth=1)) + xlab("POC (µg/kg)") + ylab("katE\ncopy number per genome")
...
panel.grid.major = element_blank(), 
        panel.grid.minor = element_blank(),
        panel.border = element_rect(colour = "black", fill=NA, linewidth=1)) + xlab("POC (µg/kg)") + ylab("katG\ncopy number per genome")
...
model_1_salinity_supp <- plot(ggeffects::ggpredict(normKatG6_enviro, terms = c("Sal_co")), show_data = TRUE, colors = "darkgrey", dot_size = 2, line_size = 1) + theme_bw() + ggtitle("") + theme(text=element_text(size=12), panel.background = element_blank(),
panel.grid.major = element_blank(), 
        panel.grid.minor = element_blank(),
        panel.border = element_rect(colour = "black", fill=NA, linewidth=1)) + xlab("Salinity (PSU)") + ylab("log10 katG\ncopy number per genome")
...
normKatG11_HL <- mgcv::gam(log10normKatG ~ s(Temp_co) + s(Sal_co) + PO4_co + POC + pro_HLI + proDarwin_umolC.kg, data=catmodels_notArctic_new_clean_SRF_extra_Sal_POC_log, method = "REML")

#HL supp figs
model_2_salinity_supp <- plot(ggeffects::ggpredict(normKatG11_HL, terms = c("Sal_co")), show_data = TRUE, colors = "darkgrey", dot_size = 2, line_size = 1) + theme_bw() + ggtitle("") + theme(text=element_text(size=12), panel.background = element_blank(),
panel.grid.major = element_blank(), 
        panel.grid.minor = element_blank(),
        panel.border = element_rect(colour = "black", fill=NA, linewidth=1)) + xlab("Salinity (PSU)") + ylab("log10 katG\ncopy number per genome")

model_2_po4_supp <- plot(ggeffects::ggpredict(normKatG11_HL, terms = c("PO4_co")), show_data = TRUE, colors = "darkgrey", dot_size = 2, line_size = 1) + theme_bw() + ggtitle("") + theme(text=element_text(size=12), panel.background = element_blank(),
panel.grid.major = element_blank(), 
        panel.grid.minor = element_blank(),
        panel.border = element_rect(colour = "black", fill=NA, linewidth=1)) + xlab("Phosphate concentraion (µg/kg)") + ylab("log10 katG\ncopy number per genome")

model_2_poc_supp <- plot(ggeffects::ggpredict(normKatG11_HL, terms = c("POC")), show_data = TRUE, colors = "darkgrey", dot_size = 2, line_size = 1) + theme_bw() + ggtitle("") + theme(text=element_text(size=12), panel.background = element_blank(),
panel.grid.major = element_blank(), 
        panel.grid.minor = element_blank(),
        panel.border = element_rect(colour = "black", fill=NA, linewidth=1)) + xlab("POC (µg/kg)") + ylab("log10 katG\ncopy number per genome")
...
normKatE_large_enviro_new8 <- mgcv::gam(log10katE ~ phosphate_dissolved_umol.kg + s(POC), data=largedata_noCO2_trans_filt_POC, method = "REML")

normKatE_large_enviro_new9 <- mgcv::gam(log10katE ~ phosphate_dissolved_umol.kg + POC, data=largedata_noCO2_trans_filt_POC, method = "REML")


normKatE_large_enviro_new9_nolog <- mgcv::gam(katE ~ phosphate_dissolved_umol.kg + POC, data=largedata_noCO2_trans_filt_POC, method = "REML")

#is the model better when make into linear

normKatG4_large_enviro_filt <- mgcv::gam(log10katG ~ s(temperature_dissolved_deg.c) + s(NO3_NO2_co) + s(PAR_co) + s(phosphate_dissolved_umol.kg) + s(POC), data=largedata_noCO2_trans_filtered_POC, method = "REML")

normKatG5_large_enviro_filt <- mgcv::gam(log10katG ~ s(temperature_dissolved_deg.c) + NO3_NO2_co + s(PAR_co) + s(phosphate_dissolved_umol.kg) + s(POC), data=largedata_noCO2_trans_filtered_POC, method = "REML")

normKatG6_large_enviro_filt <- mgcv::gam(log10katG ~ s(temperature_dissolved_deg.c) + NO3_NO2_co + s(PAR_co) + phosphate_dissolved_umol.kg + s(POC), data=largedata_noCO2_trans_filtered_POC, method = "REML")

#nolog
normKatG6_large_enviro_filt_nolog <- mgcv::gam(katG ~ s(temperature_dissolved_deg.c) + NO3_NO2_co + s(PAR_co) + phosphate_dissolved_umol.kg + s(POC), data=largedata_noCO2_trans_filtered_POC, method = "REML")


#is the model better when I make it into linear
...
#final models for large ( )
katG_large_PO4 <- plot(ggeffects::ggpredict(normKatG6_large_enviro_filt, terms = c("phosphate_dissolved_umol.kg")), show_data = TRUE, colors = "darkgrey", dot_size = 2, line_size = 1) + theme_bw() + ggtitle("") + theme(text=element_text(size=18), panel.background = element_blank(),
panel.grid.major = element_blank(), 
        panel.grid.minor = element_blank(),
        panel.border = element_rect(colour = "black", fill=NA, linewidth=1)) + xlab("Inorganic phosphate concentration (µmol/kg)") + ylab("log10 katG\ncopy number per genome")

katG_large_N <- plot(ggeffects::ggpredict(normKatG6_large_enviro_filt, terms = c("NO3_NO2_co")), show_data = TRUE, colors = "darkgrey", dot_size = 2, line_size = 1) + theme_bw() + ggtitle("") + theme(text=element_text(size=18), panel.background = element_blank(),
panel.grid.major = element_blank(), 
        panel.grid.minor = element_blank(),
        panel.border = element_rect(colour = "black", fill=NA, linewidth=1)) + xlab("Inorganic nitrogen concentration (µmol/kg)") + ylab("log10 katG\ncopy number per genome")

grid.arrange(katG_large_PO4, katG_large_N, ncol = 2)




e <- plot(ggeffects::ggpredict(normKatG6_large_enviro_filt, terms = c("phosphate_dissolved_umol.kg")), show_data = TRUE, colors = "darkgrey", dot_size = 2, line_size = 1) + theme_bw() + ggtitle("") + theme(text=element_text(size=12), panel.background = element_blank(),
panel.grid.major = element_blank(), 
        panel.grid.minor = element_blank(),
        panel.border = element_rect(colour = "black", fill=NA, linewidth=1)) + xlab("Inorganic phosphate concentration") + ylab("log10 katG\ncopy number per genome")


f <- plot(ggeffects::ggpredict(normKatG6_large_enviro_filt, terms = c("POC")), show_data = TRUE, colors = "darkgrey", dot_size = 2, line_size = 1) + theme_bw() + ggtitle("") + theme(text=element_text(size=12), panel.background = element_blank(),
panel.grid.major = element_blank(), 
        panel.grid.minor = element_blank(),
        panel.border = element_rect(colour = "black", fill=NA, linewidth=1)) + xlab("POC (µg/kg)") + ylab("log10 katG\ncopy number per genome")

f2 <- plot(ggeffects::ggpredict(normKatG6_large_enviro_filt, terms = c("POC")), show_data = TRUE, colors = "darkgrey", dot_size = 2, line_size = 1) + theme_bw() + ggtitle("") + theme(text=element_text(size=12), panel.background = element_blank(),
panel.grid.major = element_blank(), 
        panel.grid.minor = element_blank(),
        panel.border = element_rect(colour = "black", fill=NA, linewidth=1)) + xlab("POC (µg/kg)") + ylab("katG\ncopy number per genome")


katE_large_PO4 <- plot(ggeffects::ggpredict(normKatE_large_enviro_new9, terms = c("phosphate_dissolved_umol.kg")), show_data = TRUE, colors = "darkgrey", dot_size = 2, line_size = 1) + theme_bw() + ggtitle("") + theme(text=element_text(size=18), panel.background = element_blank(),
panel.grid.major = element_blank(), 
        panel.grid.minor = element_blank(),
        panel.border = element_rect(colour = "black", fill=NA, linewidth=1)) + xlab("Inorganic phosphate concentration (µmol/kg)") + ylab("log10 katE\ncopy number per genome")

h <- plot(ggeffects::ggpredict(normKatE_large_enviro_new9, terms = c("POC")), show_data = TRUE, colors = "darkgrey", dot_size = 2, line_size = 1) + theme_bw() + ggtitle("") + theme(text=element_text(size=12), panel.background = element_blank(),
panel.grid.major = element_blank(), 
        panel.grid.minor = element_blank(),
        panel.border = element_rect(colour = "black", fill=NA, linewidth=1)) + xlab("POC (µg/kg)") + ylab("log10 katE\ncopy number per genome")

h2 <- plot(ggeffects::ggpredict(normKatE_large_enviro_new9, terms = c("POC")), show_data = TRUE,  colors = "darkgrey", dot_size = 2, line_size = 1) + theme_bw() + ggtitle("") + theme(text=element_text(size=12), panel.background = element_blank(),
panel.grid.major = element_blank(), 
        panel.grid.minor = element_blank(),
        panel.border = element_rect(colour = "black", fill=NA, linewidth=1)) + xlab("POC (µg/kg)") + ylab("katE\ncopy number per genome")  

grid.arrange(f, h, ncol = 2)
grid.arrange(katG_POC, katG_Iron, katG_sar11, katG_pro, f, h, ncol = 2)
...
#use this dataset
catmodels_modeleddata_notArctic_SRF
...
catmodels_modeleddata_notArctic_SRF_newformat <- catmodels_notArctic_new_clean_SRF_extra %>%
...
catalases_small_trans_enviro_bystation_katG

####

model_katG <- lm(reads ~ Region, data = catalases_small_trans_enviro_bystation_katG)

#not normally distributed
shapiro_test(residuals(model_katG))
#p>0.05 so have to use aov
x <- aov(reads ~ Region, data = catalases_small_trans_enviro_bystation_katG) %>%
  tukey_hsd()

#katG 
#south pacific significantly higher than other regions

#katE
model_katE <- lm(reads ~ Region, data = catalases_small_trans_enviro_bystation_katE)

#not normally distributed
shapiro_test(residuals(model_katE))
#p < 0.05 therefore the distribution is not normal and we have to use the kruskal test
kruskal.test(reads ~ Region, data = catalases_small_trans_enviro_bystation_katE)
#p > 0.05

#get the averages

small_regions_katG_averages <- catalases_small_trans_enviro_bystation_katG %>%
  group_by(Region) %>%
  summarise(meankatG = mean(reads),
            n = n())
#repeat for the large size fraction

catalases_small_trans_enviro_bystation_katE
#####
model_katG <- lm(reads ~ Region, data = catalases_large_trans_enviro_bystation_katG)

#not normally distributed
shapiro_test(residuals(model_katG))

aov(reads ~ Region, data = catalases_large_trans_enviro_bystation_katG) %>%
  tukey_hsd()

#ns

model_katE <- lm(reads ~ Region, data = catalases_large_trans_enviro_bystation_katE)

#not normally distributed
shapiro_test(residuals(model_katE))

aov(reads ~ Region, data = catalases_large_trans_enviro_bystation_katE) %>%
  tukey_hsd()
...
#set of Families: all families for supplemental section I think
...
#################
#rescaling
catalases_alltaxa_forplot_filt

#also want to scale the two poseidoniales to the number of MAGs because it doesnt look like taxa was able to be detected in the metaG

#first I will filter out these and scale their relative abundances in excel
write_xlsx(catalases_alltaxa_forplot_filt, "catalases_alltaxa_forplot_filt.xlsx")
...
proportioncatalase_katG <- ggplot(data = catalases_alltaxa_forplot_filt_updated, aes(x = reorder(New_name2, row_median), y = propKatG)) + coord_flip() +
  geom_col(fill= "blue", color = "black") + ylab("Proportion of MAGs") + xlab("") + theme_bw() + scale_y_continuous(expand = expansion(mult = c(0, .1))) + theme(text = element_text(size = 16), panel.background = element_blank(),
...
numMAGs <- ggplot(data = catalases_alltaxa_forplot_filt_updated, aes(x = reorder(New_name2, row_median), y = sqrt(row_median))) + coord_flip() +
  geom_col(fill= "grey", color = "black") + ylab("Metagenome relative abundance (sqrt)") + xlab("Taxa") + theme_bw() + scale_y_continuous(expand = expansion(mult = c(0, .1))) + theme(text = element_text(size = 16), panel.background = element_blank(),
panel.grid.major = element_blank(), 
        panel.grid.minor = element_blank(),
        panel.border = element_rect(colour = "black", fill=NA, linewidth=1),
strip.text = element_blank(),
...
proportioncatalase_katE <- ggplot(data = catalases_alltaxa_forplot_filt_updated, aes(x = reorder(New_name2, row_median), y = propKatE)) + coord_flip() +
  geom_col(fill= "darkgreen", color = "black") + ylab("Proportion of MAGs") + xlab("") + theme_bw() + scale_y_continuous(expand = expansion(mult = c(0, .1))) + theme(text = element_text(size = 16), panel.background = element_blank(),
                                                                                        axis.text.y = element_blank(),
...
library(gridExtra)
grid.arrange(numMAGs, proportioncatalase_katG, proportioncatalase_katE, ncol = 3, widths = c(2.7, 2.7, 2.7), heights = c(2.5, 2.5, 2.5))

grid.arrange(numMAGs, proportioncatalase_katG, proportioncatalase_katE, ncol = 3, widths = c(1, 0.5, 0.5), heights = c(10, 10, 10))
...
KatG_catmn_KatE_genome_size_alltaxa_katG <- KatG_catmn_KatE_genome_size_alltaxa %>%
  filter(n_KatG < 3)
...
hannah_katG <- ggplot(KatG_catmn_KatE_genome_size_alltaxa_katG, aes(x=as.character(n_KatG), y=Genome.size)) + 
    geom_boxplot(fill="grey") + theme_bw() + xlab("katG copy number per genome") + ylab("Genome size (bp)") + coord_flip() + theme(text = element_text(size = 12), panel.background = element_blank(),
panel.grid.major = element_blank(), 
        panel.grid.minor = element_blank(),
        panel.border = element_rect(colour = "black", fill=NA, linewidth=1)) 

hannah_katE <- ggplot(KatG_catmn_KatE_genome_size_alltaxa_katE, aes(x=as.character(n_KatE), y=Genome.size)) + 
    geom_boxplot(fill="grey") + theme_bw() + xlab("katE copy number per genome") + ylab("Genome size (bp)") + coord_flip() + theme(text = element_text(size = 12), panel.background = element_blank(),
panel.grid.major = element_blank(), 
        panel.grid.minor = element_blank(),
        panel.border = element_rect(colour = "black", fill=NA, linewidth=1)) 
...
##############doing the statistics for the GC content and genome size
KatG_catmn_KatE_genome_size_alltaxa_katE_trans <- KatG_catmn_KatE_genome_size_alltaxa_katE %>%
  transform(n_KatE = as.character(n_KatE))

model_mydata <- lm(Genome.size ~ n_KatE, data = KatG_catmn_KatE_genome_size_alltaxa_katE_trans)

#is there a statistical difference between the genome size and copy num of katE?
shapiro.test(residuals(model_mydata))

kruskal.test(Genome.size ~ n_KatE, data = KatG_catmn_KatE_genome_size_alltaxa_katE_trans)

#which groups
pairwise.wilcox.test(KatG_catmn_KatE_genome_size_alltaxa_katE_trans$Genome.size,KatG_catmn_KatE_genome_size_alltaxa_katE_trans$n_KatE, p.adjust.method = "BH")

#repeat for GC content
model_mydata <- lm(GC.content ~ n_KatE, data = KatG_catmn_KatE_genome_size_alltaxa_katE_trans)

#is there a statistical difference between the genome size and copy num of katE?
shapiro.test(residuals(model_mydata))

kruskal.test(GC.content ~ n_KatE, data = KatG_catmn_KatE_genome_size_alltaxa_katE_trans)

#which groups
pairwise.wilcox.test(KatG_catmn_KatE_genome_size_alltaxa_katE_trans$GC.content, KatG_catmn_KatE_genome_size_alltaxa_katE_trans$n_KatE, p.adjust.method = "BH")

#################repeating the genome size and the gc content
KatG_catmn_KatE_genome_size_alltaxa_katG

KatG_catmn_KatE_genome_size_alltaxa_katG_trans <- KatG_catmn_KatE_genome_size_alltaxa_katG %>%
  transform(n_KatG = as.character(n_KatG))

model_mydata <- lm(Genome.size ~ n_KatG, data = KatG_catmn_KatE_genome_size_alltaxa_katG_trans)

#is there a statistical difference between the genome size and copy num of katE?
shapiro.test(residuals(model_mydata))

kruskal.test(Genome.size ~ n_KatG, data = KatG_catmn_KatE_genome_size_alltaxa_katG_trans)

#which groups
pairwise.wilcox.test(KatG_catmn_KatE_genome_size_alltaxa_katG_trans$Genome.size,KatG_catmn_KatE_genome_size_alltaxa_katG_trans$n_KatG, p.adjust.method = "BH")

#repeat for GC content
model_mydata <- lm(GC.content ~ n_KatG, data = KatG_catmn_KatE_genome_size_alltaxa_katG_trans)

#is there a statistical difference between the genome size and copy num of katE?
shapiro.test(residuals(model_mydata))

kruskal.test(GC.content ~ n_KatG, data = KatG_catmn_KatE_genome_size_alltaxa_katG_trans)

#which groups
pairwise.wilcox.test(KatG_catmn_KatE_genome_size_alltaxa_katG_trans$GC.content, KatG_catmn_KatE_genome_size_alltaxa_katG_trans$n_KatG, p.adjust.method = "BH")
###################quick test to look at the medians of the genome size and the GC contents for katE and katG copy number per genome
numbersforpaper_katE <- KatG_catmn_KatE_genome_size_alltaxa_katE_trans %>%
  group_by(n_KatE) %>%
  summarise(meansize = median(Genome.size),
            meangc = median(GC.content),
            n = n())

numbersforpaper_katG <- KatG_catmn_KatE_genome_size_alltaxa_katG_trans %>%
  group_by(n_KatG) %>%
  summarise(meansize = median(Genome.size),
            meangc = median(GC.content),
            n = n())

#calculating percent difference in katG for genome size
3713423-2026194/2026194
...
write_xlsx(only214genomes_metadata, "only214genomes_metadata.xlsx")
...
ggplot(data=michelledata_copies_twospecies_long, aes(x=copies, group=gene, fill=gene)) +
  geom_histogram(alpha = 0.4, position=position_dodge()) +
    theme_classic() + scale_x_continuous(expand = expansion(mult = c(0, .1))) + scale_y_continuous(expand = expansion(mult = c(0, .1))) + scale_fill_manual(
                        values=c("green", "blue"), , labels=c("katE", "katG")) + xlab("catalase copy number per genome") + ylab("Number of genomes") + facet_wrap(~Species, ncol = 1)

densplot_data <- michelledata_copies_twospecies_long %>%
  mutate(copies = transform(as.character(copies))) %>%
  group_by(Species) %>%
    count()

densplot_data2 <- michelledata_copies_twospecies_long %>%
  mutate(copies = transform(as.character(copies))) %>%
  group_by(copies, gene, Species) %>%
 tally()

hist_plot <- left_join(densplot_data2, densplot_data,
          by = "Species")


  
write_xlsx(hist_plot_prop, "hist_plot_prop.xlsx")

hist_plot_prop_new <- read_xlsx("hist_plot_prop_new.xlsx")

hist_plot_prop <- hist_plot_prop_new %>%
  mutate(propcat = numcat/total)

ggplot(data=hist_plot_prop, aes(x=as.character(copies), y=propcat, fill=gene)) + geom_col(alpha = 0.4, position = "dodge") +
    theme_classic() + xlab("catalase copy number per genome") + ylab("Proportion of genomes") + facet_wrap(~Species, ncol = 1)
###############
